...
class Arb:
    ...
    def event_link(self) -> str:
        if self.bookmaker['id'] == 80:
            ...
            return self.bookmaker['url'] + quote(f"zapas-sance/{self.event_name}/{self.event_direct_link}")
    ...
    def bet_link(self) -> str:
        ...
        if self.bookmaker['id'] == 39:
            ...
            ticket = f"vytvorit-tiket?bets=AKU%200,{self.bet_direct_link}&amount=400&matchId={match_id}"
